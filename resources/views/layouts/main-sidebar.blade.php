                    ...
                    @can("مشتريات الموردين")
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                ...
                                @endcan
                                <li><a class="slide-item" href="{{ url('/' . $page='supplierPays') }}">قائمة السداد</a></li>
