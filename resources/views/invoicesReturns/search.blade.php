...
@section('title')
     قائمة الفواتير المرتجعة - مصنع ايام زمان
@stop
@section('css')
...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">مشتريات الموردين</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة الفواتير المرتجعة</span>
						</div>
                    </div>
						...
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-start">
                                    <a class="mx-1 btn btn-outline-success" href="{{ route('InvoicesReturns.index') }}">الرجوع للقائمة</a>
