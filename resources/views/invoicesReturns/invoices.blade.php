...
@section('title')
     قائمة المرتجعات - مصنع ايام زمان
@stop
@section('css')
...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">مشتريات الموردين</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة مرتجع المشتريات</span>
						</div>
                    </div>
							...
							<div class="card-header pb-0">
								<div class="d-flex justify-content-start">
                                    @can("اضافة مرتجع مشتريات")
                                        <a class="mx-1 btn btn-outline-primary" href="{{ route('InvoicesReturns.create') }}">اضافة فاتورة مرتجع</a>
                                    @endcan
                                                                ...
                                                                <td>
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu tx-13">
                                                                            ...
                                                                            <a class="dropdown-item" title="تعديل" href="{{route("InvoicesReturns.edit",$invoice->id)}}" ><i class="text-secondary far fa-edit"></i>&nbsp;&nbsp;تعديل</a>
                                                                            @endcan
                                                                            ...
                                                                            @endcan
                                                                            @can("عرض مرتجع مشتريات")
                                                                            <a class="dropdown-item"  title="عرض الملف" href="{{ route("InvoicesReturns.show",$invoice->id) }}"><i class="text-success far fa-eye"></i>&nbsp;&nbsp;عرض</a>
                                                                            @endcan
                                                                        </div>
                                                                    </div>
                                                                </td>
                                ...
                                <div class="modal" id="select2modal">
                                    <div class="modal-dialog" role="document">
                                        <form action="{{url("InvoicesReturns/search")}}" method="POST">
                                            @method("get")
                                            @csrf
                                            <div class="modal-content modal-content-demo">
                                                <div class="modal-header">
