...
@section('title')
أضافة فاتورة مرتجع - مصنع ايام زمان
@stop
@section('css')
...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">مشتريات الموردين</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ أضافة فاتورة مرتجع</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
						...
						<div class="card">
							<div class="card-body">
								<div class="main-content-label mg-b-5">
									اضافة فاتورة مرتجع مورد
								</div>
                                <p class="mg-b-20">برجاء ملئ جميع البيانات المطلوبة حتي يتم تسجيل الفاتورة.</p>
                                <p class="mg-b-20">بيانات المورد</p>
								<form action="{{ route("InvoicesReturns.store") }}" id="selectForm" name="matarial" autocomplete="off" method="POST">
                                    @method('post')
                                    @csrf
